...
public interface IStudentMapper {
    ...
    //리터타입 : void -> insert 함수 실행한 뒤, 조회된 결과가 없음을 의미
    //
...
/*
        학생 전체 조회 쿼리
        <p>
        함수명 : getStudentList -> Mapper XML 파일의 ID와 동일하며, 여러개 작성 가능한 SQL 쿼리를 구분하기 위한 값
        Parameter : 없음
...
*/
    List<StudentDTO> getStudentList() throws Exception; //조회결과 여러개
/*
